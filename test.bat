...
IF "%1" == "Walk" (
    java -Dfile.encoding=UTF-8 -cp "tests/lib/hamcrest-core-1.3.jar;tests/lib/junit-4.11.jar;tests/artifacts/WalkTest.jar;./out/production/JavaAdvanced" info.kgeorgiy.java.advanced.walk.Tester %1 ru.ifmo.ctddev.makarenko.walk.Walk %2
)
IF "%1" == "RecursiveWalk" (
    java -Dfile.encoding=UTF-8 -cp "tests/lib/hamcrest-core-1.3.jar;tests/lib/junit-4.11.jar;tests/artifacts/WalkTest.jar;./out/production/JavaAdvanced" info.kgeorgiy.java.advanced.walk.Tester %1 ru.ifmo.ctddev.makarenko.walk.RecursiveWalk %2
)
IF "%1" == "SortedSet" (
...
IF "%1" == "scalar" (
    java -Dfile.encoding=UTF-8 -cp "tests/lib/hamcrest-core-1.3.jar;tests/lib/junit-4.11.jar;tests/lib/quickcheck-0.6.jar;tests/artifacts/IterativeParallelismTest.jar;./out/production/JavaAdvanced" info.kgeorgiy.java.advanced.concurrent.Tester %1 ru.ifmo.ctddev.makarenko.concurrent.IterativeParallelism %2
)
IF "%1" == "list" (
    java -Dfile.encoding=UTF-8 -cp "tests/lib/hamcrest-core-1.3.jar;tests/lib/junit-4.11.jar;tests/lib/quickcheck-0.6.jar;tests/artifacts/IterativeParallelismTest.jar;./out/production/JavaAdvanced" info.kgeorgiy.java.advanced.concurrent.Tester %1 ru.ifmo.ctddev.makarenko.concurrent.IterativeParallelism %2
)