...
//
//public class WebCrawlerOld implements Crawler {
//
...
//                    connections.computeIfPresent(host, (key, value) -> Math.abs(value) - 1);
//                    downloaded.add(url);
//                    if (depth > 1) {
...
//                    if (depth > 1 && state.unique.add(link)) {
...
//    }
//
//    public WebCrawlerOld(Downloader downloader, int downloaders, int extractors, int perHost) {
...
//        }
//
//        try (Crawler crawler = new WebCrawlerOld(new CachingDownloader(), downloaders, extractors, perHost)) {
